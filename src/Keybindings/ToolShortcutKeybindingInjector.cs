...
{
	public class ToolShortcutKeybindingInjector : ILoadableSingleton
	{
		...
		private readonly KeyBindingGroupSpecificationService keyBindingGroupSpecificationService;
		private readonly KeyBindingSpecificationService keyBindingSpecificationService;
		private readonly KeyBindingRegistry keyBindingRegistry;
		
		public ToolShortcutKeybindingInjector(
			KeyBindingGroupSpecificationService keyBindingGroupSpecificationService,
			KeyBindingSpecificationService keyBindingSpecificationService,
			KeyBindingRegistry keyBindingRegistry
		) {
			this.keyBindingGroupSpecificationService = keyBindingGroupSpecificationService;
			this.keyBindingSpecificationService = keyBindingSpecificationService;
			this.keyBindingRegistry = keyBindingRegistry;
		}
		
		public void Load()
		{
			const int firstGroupOrderIndex = 666333666; //"Random, but high"
			...
			registerKeybindings(firstGroupOrderIndex, groups);
		}
		
		private void registerKeybindings(int firstOrderIndex, Group[] groups)
		{
			var currentGroupIndex = firstOrderIndex;
		...
		private void insertSorted<T>(List<T> list, List<T> newEntries, int firstIndex, Func<T, int> orderGetter, Func<T, string> debugGetter)
		{
